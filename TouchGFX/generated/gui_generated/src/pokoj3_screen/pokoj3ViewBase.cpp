...
pokoj3ViewBase::pokoj3ViewBase() :
    buttonCallback(this, &pokoj3ViewBase::buttonCallbackHandler)
{
    ...
    textCounter.setTypedText(touchgfx::TypedText(T___SINGLEUSE_3NC4));
...
void pokoj3ViewBase::setupScreen()
{

}

void pokoj3ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &goBack)
    {
        //GoBack
