...
pokoj1ViewBase::pokoj1ViewBase() :
    buttonCallback(this, &pokoj1ViewBase::buttonCallbackHandler)
{
    ...
    textCounter.setTypedText(touchgfx::TypedText(T___SINGLEUSE_Q982));
...
void pokoj1ViewBase::setupScreen()
{

}

void pokoj1ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &goBack)
    {
        //GoBack
